...
export const tr: SiteContent = {
  ...
  sample: {
    ...
    jobsNote:
      "İnce çubuk ölçüm hatasıdır. Aralıkları çakışan alanlar tek grup olarak gösterilir — hatadan küçük farklara sıra vermiyoruz. Alt gruba düşen alanların neden düştüğü de metinde yazılıdır.",
    tierLabel: "{n}. grup",
    tierNote:
      "İlk grupta iki alan var. Bu değerlendirme onları ayırt edemez; ikisi de açık kalır, ayrımı deneyim yapar.",
    jobs: [
      { name: "Tasarım ve Geliştirme", score: 92, band: [87, 97], tier: 1 },
      { name: "Otomotiv ve Havacılık", score: 88, band: [83, 93], tier: 1 },
      { name: "Araştırma ve Eğitim", score: 79, band: [74, 84], tier: 2 },
      { name: "İmalat ve Üretim", score: 74, band: [69, 79], tier: 2 },
      { name: "Robotik ve Otomasyon", score: 70, band: [65, 75], tier: 2 },
      { name: "BT Entegrasyonu ve Veri Analizi", score: 66, band: [61, 71], tier: 3 },
      { name: "Enerji ve Tesis", score: 61, band: [56, 66], tier: 3 },
      { name: "İnşaat ve Tesis Yönetimi", score: 48, band: [43, 53], tier: 4 },
      { name: "Biyomedikal ve Sağlık Hizmetleri", score: 45, band: [40, 50], tier: 4 },
      { name: "Kamu Kurumları ve Diğer Alanlar", score: 41, band: [36, 46], tier: 4 },
    ],
    ...
    tabs: [
      {
        ...
        chartNote: "İlk grup başvuru stratejisinin temeli olur; grup içinde sıra verilmez.",
