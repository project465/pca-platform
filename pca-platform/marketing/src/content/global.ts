    ...
    tabs: [
      {
        ...
        chartNote: "Simulation & CAE came out highest across the ten job areas.",
        capTitle: "Job area analysis",
        capBody: "Ten mechanical engineering job areas, scored out of 100 and ranked.",
      ...
      },
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            body: [
              "The report is built around Simulation & CAE. Second and third are context for how wide the interest runs.",
            ],
            table: {
              head: ["Rank", "Area", "Score", "How the report uses it"],
              rows: [
                ["1st", "Simulation & CAE", "80", "Main analysis"],
                ["2nd", "Mechanical design", "73", "Supporting"],
                ["3rd", "Robotics & automation", "67", "Supporting"],
              ],
            },
          },
        ],
        capTitle: "Core diagnostic summary",
        capBody: "Top area, score, ranking and work style in one place.",
      ...
      },
      {
        ...
        capArrow: "Roles ranked, not just listed",
      },
      {
        no: "05",
        nav: "Projects",
