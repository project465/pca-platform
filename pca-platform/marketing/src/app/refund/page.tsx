  ...
  const ko: Clause[] = [
    ...
    },
    {
      ...
      body: [
        ...
        {
      title: "결과지를 넓히는 결제는 기준이 다릅니다",
      body: [
        "이미 검사를 끝낸 뒤 남은 절을 여는 결제(업그레이드)는 ‘응시 시작’ 을 기준으로 쓸 수 없습니다. 그래서 기준이 하나 뒤로 갑니다 — 넓어진 결과지를 한 번도 열지 않았다면 결제일로부터 7일 안에 전액 돌려드립니다.",
        "한 번 여신 뒤에는 돌려드리지 않습니다. 결제 화면에서 이 점을 미리 알려 드리고, 언제 처음 여셨는지만 기록합니다. 무엇을 읽으셨는지는 남기지 않습니다.",
      ],
    },
    {
      title: "기간권은 남은 기간만큼 돌려드립니다",
      body: [
        "일정 기간 동안 결과지를 열어 두는 상품은 계속거래에 해당해, 기간 중 언제든 해지하실 수 있습니다. 남은 일수만큼 일할로 계산해 돌려드리고 위약금은 받지 않습니다.",
        "해지하면 그날로 열람이 끝납니다. 그전에 보신 결과지를 되돌리지는 않습니다.",
      ],
    },
    {
      title: "다른 곳에서 응시권을 사신 경우",
      body: [
        "쇼핑몰에서 응시권을 구매하고 코드를 받으신 경우, 환불은 구매하신 곳의 규정을 따릅니다. 저희는 그 코드를 막거나 이미 등록된 좌석을 회수합니다.",
        "아직 검사를 시작하지 않으셨다면 회수됩니다. 시작하신 뒤에는 회수하지 않습니다 — 이미 받으신 결과를 빼앗는 일이 되기 때문입니다.",
      ],
    },
    {
