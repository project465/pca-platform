    ...
    <MentoringShell user={user} current="/mentoring/guide" isMentor={Boolean(mine)}>
      ...
      <div className="panel">
        ...
        <p className="help" style={{ marginTop: 12 }}>
          ...
          <br />
          <b>학과가 멘토링 이용권을 사둔 경우, 그 학과 학생은 본인이 내지 않습니다.</b>{" "}
          받은 계정으로 로그인하면 결제 화면이 나오지 않습니다. 다만 이용권은 건수로
          사두는 것이라 <b>다 쓰면 본인 결제로 넘어갑니다.</b> 계약 기간이 지났거나 고른
          세션이 이용권 한도보다 비싼 경우에도 그렇습니다. 신청 화면에 왜 결제인지
          적어두므로, 결제 안내가 보이면 학과 담당자에게 확인해 보세요.
        </p>
      </div>
