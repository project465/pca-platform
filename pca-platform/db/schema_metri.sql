-- ============================================================
--  Careermetri 확장 스키마 — Engineering Career Intelligence
...
--  그 중 120문항에 6개 업무성향이 심어져 있다. Careermetri 는 이 문항을 새로 쓰지
...
-- ============================================================
--  27. 커리어메트리 플러스 — 전공이 없는 검사지와 전공 적합 점수
--
...
-- 30. 무료 구간과 유료 구간
--
-- 커리어메트리 플러스가 파는 것은 지표가 아니라 사슬이다.
--
